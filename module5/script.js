...
//    nom du produit (featuredProductName), 
//    prix HT (featuredProductPriceHT), 
...
let featuredProductName = "T-shirt Anya";
let featuredProductPriceHT = 95;
let featuredProductDescription = "T-shirt en coton avec la tête de Anya imprimée.";
let featuredProductImage = "https://img.joomcdn.net/e1eb0199075a4b99d385294556ccf11eb06e4ac7_original.jpeg";  
...
function createFeaturedProductCard(){
  ...
  descriptionParagraph.textContent = featuredProductDescription;
...
const card2 = createFeaturedProductCard();
productList.appendChild(card2);
